...
WEATHER_KEY = "f1ab87d880075ea6" # 500 quests per day
...
#####################
# Aktuelle Wetterlage
# http://api.wunderground.com/api/f1ab87d880075ea6/conditions/q/50.192900,11.8035702.json
...
############
# Astronomie
# http://api.wunderground.com/api/f1ab87d880075ea6/astronomy/q/50.192900,11.8035702.json
...
##################
# Wettervorhersage
# http://api.wunderground.com/api/f1ab87d880075ea6/forecast/q/50.192900,11.8035702.json
...
################
# Homematic CCU2
# http://192.168.137.66/addons/xmlapi/state.cgi?device_id=2390,2465
db = MySQLdb.connect(
    SQLHOST,
    SQLUSER,
    SQLPW,
